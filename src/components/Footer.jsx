...
const Footer = () => {
  return (
    <footer className="layout block w-full absolute bottom-0">
      <div className="md:grid gap-8 text-center sm:text-left md:grid-cols-6 lg:grid-cols-9 md:place-items-start">
        ...
        <div className="col-span-4 w-full flex flex-col sm:flex-row   justify-between gap-8">
